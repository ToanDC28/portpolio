    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <div class="text-base lg:text-lg mt-8 py-8">
                    <p v-for="item in abouts" :key="item.id">
                        &middot; <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">{{ item.key }}</span>: {{ item.des }} 
                    </p>
                </div>
...
const abouts = ref([
    {
        id : 1,
        key: 'Adaptability',
        des: 'Always looking for new challenges and eager to explore emerging technologies.'
    },
    {
        id: 2,
        key: 'Resilience',
        des: 'Maintaining good health and effectively managing work pressure in demanding environments.'
    },
    {
        id: 3,
        key: 'Mindset',
        des: 'Open-minded with a continuous learning approach and willingness to adopt innovative solutions.'
    },
    {
        id: 3,
        key: 'Problem-solving',
        des: 'Strong analytical skills with the ability to work both independently and collaboratively within teams.'
    }
])
</script>