        ...
        <div class="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto relative">
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-justify lg:text-left mx-auto max-w-xl">
                        I am a student majoring in information technology at FPT University. 
                        As a recent graduate in Information Technology, I am passionate about 
                        programming and always eager to take on new challenges. I always seek 
                        and learn new things, look for opportunities and challenges that make 
                        me more and more interested in my work. I enjoy exploring new technologies 
                        and understanding how software is built and operates. Although my experience 
                        is still growing, I am highly motivated to learn, contribute to real-world projects, 
                        and continuously enhance my skills. I thrive in dynamic environments where 
                        I can collaborate, solve problems, and develop innovative solutions. I am 
                ...
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
                            <img src="@/assets/avata.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
